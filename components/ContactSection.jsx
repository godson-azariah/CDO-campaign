    ...
    <section className="trap-section-light py-[40px] sm:py-[48px] lg:py-[76px]">
      ...
      */}
      <div className="relative mx-auto w-full max-w-[1440px] px-5 lg:px-[38px]">
        ...
        <div className="relative mx-auto grid max-w-[1320px] items-stretch gap-6 sm:gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,458px)] lg:gap-[40px]">
          {/*
            ...
            it keeps that position: form on the left, reasons on the right.
          */}
