...
export function confirmationEmail(lead) {
  const bodyHtml = `
    ...
    <p style="margin:0 0 16px 0;font-family:${FONT};font-size:15px;line-height:25px;color:${BODY};">
      Roney Soloman will be in touch by email within one business day to arrange
...
Roney Soloman will be in touch by email within one business day to arrange a time that suits you. If anything changes in the meantime, just reply to this message.
